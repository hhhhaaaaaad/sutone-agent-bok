...
后端控制器：
- [AgentServiceController.java](file:///Users/sudonghao/coding/gitcode/KnowledgePlanet/ai-agent-scaffold/sutone-agent-bok/sutone-agent-bok-trigger/src/main/java/cn/sukesutone/ai/trigger/http/AgentServiceController.java)

接口基础前缀：
- `/api/v1/`

统一响应结构（泛型包装）：
- [Response.java](file:///Users/sudonghao/coding/gitcode/KnowledgePlanet/ai-agent-scaffold/sutone-agent-bok/sutone-agent-bok-api/src/main/java/cn/sukesutone/ai/api/response/Response.java)
- 成功码：`code = "0000"`（见 [ResponseCode.java](file:///Users/sudonghao/coding/gitcode/KnowledgePlanet/ai-agent-scaffold/sutone-agent-bok/sutone-agent-bok-types/src/main/java/cn/sukesutone/ai/types/enums/ResponseCode.java)）
